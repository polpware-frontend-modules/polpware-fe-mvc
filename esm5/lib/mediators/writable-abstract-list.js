...
export var WritableListMediator = ListMediator.extend({
    ...
    onGlobalProviderUpdate: function () {
        ...
        // Changes
        if (changeSet.add) {
            var candidate = _.filter(changeSet.changes.added, function (thisItem) {
