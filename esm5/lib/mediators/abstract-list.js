...
export var ListMediator = ClassBuilder.extend({
    ...
    loadInitData: function () {
        ...
        var promise = dataProvider.getFirstPage({ data: _.extend({}, dataParams) });
    ...
    loadMore: function () {
        ...
        self._isLoadingData = true;
        var prms = dataProvider.getNextPage({ data: _.extend({}, dataParams) }).then(function () {
            $data.hasMoreData(dataProvider.hasNextPage());
